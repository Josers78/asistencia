...
export async function buscarFamilia() {
    ...
    contenedor.classList.add('contenedor-familias');
...
async function mostrarIntegrantes(docId) {
    ...
    btnRegresar.textContent = "⬅️ Regresar";
    btnRegresar.classList.add('btn-regresar');
    btnRegresar.onclick = () => {
        buscarFamilia(); // Vuelve a mostrar los resultados de búsqueda
    };
    familiaDiv.appendChild(btnRegresar);
}
